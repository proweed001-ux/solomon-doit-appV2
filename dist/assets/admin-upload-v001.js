...
function selectFile(file){
  ...
  $('#result').innerHTML=file
    ?`เลือก <b>${file.name}</b> แล้ว<br>กด “แปลง JSON และอัปโหลด” ระบบจะอ่าน แปลง JSON อัปโหลด และตั้งเป็นข้อมูลล่าสุดให้อัตโนมัติ`
    :'ยังไม่มีผลตรวจ';
...
function bind(){
  ...
  if(test)test.onclick=()=>cloudMessage('Cloud พร้อมตรวจจริงเมื่อกดแปลง JSON และอัปโหลด');
  historyRows();
}
