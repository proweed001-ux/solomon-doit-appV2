(()=>{'use strict';
const APP_VERSION='Solomon DOIT Pro V2.8.2';
function lockVersion(){
  ...
  try{const m=document.querySelector('#msg');if(m)m.textContent=(m.textContent||'').replace(/V2\.5\.9|V2\.7\.9|V2\.8\.0|V2\.8\.1/g,'V2.8.2')}catch(e){}
}
lockVersion();
