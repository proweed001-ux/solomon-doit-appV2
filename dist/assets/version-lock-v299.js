(()=>{'use strict';
const APP_VERSION='Solomon DOIT Pro V2.7.9';
const READY_TEXT='พร้อมใช้งาน V2.7.9';
function lockVersion(){
  ...
  try{const m=document.querySelector('#msg');if(m&&/V2\.5\.9|V2\.7\.9/.test(m.textContent||''))m.textContent=(m.textContent||READY_TEXT).replace(/V2\.5\.9/g,'V2.7.9')}catch{}
}
lockVersion();
