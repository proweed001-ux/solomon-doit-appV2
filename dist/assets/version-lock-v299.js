(()=>{'use strict';
const APP_VERSION='Solomon DOIT Pro V2.9.1';
...
function lockVersion(){
  ...
  try{const m=document.querySelector('#msg');if(m)m.textContent=(m.textContent||'').replace(/V2\.5\.9|V2\.7\.9|V2\.8\.0|V2\.8\.1|V2\.8\.2|V2\.8\.3|V2\.8\.4|V2\.8\.5|V2\.8\.6|V2\.9\.0/g,'V2.9.1')}catch(e){}
  loadAppCoordinator();
}
lockVersion();
