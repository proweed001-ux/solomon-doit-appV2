(()=>{'use strict';
const APP_VERSION='Solomon DOIT Pro V2.8.6';
function lockVersion(){
  ...
  try{const m=document.querySelector('#msg');if(m)m.textContent=(m.textContent||'').replace(/V2\.5\.9|V2\.7\.9|V2\.8\.0|V2\.8\.1|V2\.8\.2|V2\.8\.3|V2\.8\.4|V2\.8\.5/g,'V2.8.6')}catch(e){}
}
lockVersion();
