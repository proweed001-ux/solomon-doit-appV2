...
mustContain("dist/performance-reveal.html", "translateX(${visible ? rank * 100 : 520}%)");
...
mustContain("dist/performance-reveal.html", "function animateRaceTransition");
...
mustContain("dist/performance-reveal.html", ".slice(-6)");
