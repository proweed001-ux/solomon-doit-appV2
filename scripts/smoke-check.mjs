...
mustContain("dist/performance-reveal.html", "function hydratePerformancePack(pack)");
mustContain("dist/performance-reveal.html", ".map(result => hydratePerformancePack(result.value))");
